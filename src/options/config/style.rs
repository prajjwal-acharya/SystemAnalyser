...
impl Styles {
    pub fn new(args: &BottomArgs, config: &Config) -> anyhow::Result<Self> {
        ...
        if let Some(border_type_str) = &args.style.border_type {
            palette.border_type = match border_type_str.to_lowercase().as_str() {
                "plain" => tui::widgets::BorderType::Plain,
                "rounded" => tui::widgets::BorderType::Rounded,
                "double" => tui::widgets::BorderType::Double,
                "thick" => tui::widgets::BorderType::Thick,
                _ => tui::widgets::BorderType::Plain, // fallback
            };
        }
    ...
    fn from_theme(theme: &str) -> anyhow::Result<Self> {
        ...
        match lower_case.as_str() {
            ...
            "catppuccin" => Ok(Self::catppuccin_palette()),
            "catppuccin-light" => Ok(Self::catppuccin_light_palette()),
            "tokyonight" => Ok(Self::tokyonight_palette()),
            "tokyonight-light" => Ok(Self::tokyonight_light_palette()),
            "dracula" => Ok(Self::dracula_palette()),
            _ => Err(
