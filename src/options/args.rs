...
pub struct StyleArgs {
    #[arg(
        ...
        help = indoc! {
            "Use a built-in color theme, use '--help' for info on the colors. [possible values: default, default-light, gruvbox, gruvbox-light, nord, nord-light, catppuccin, catppuccin-light, tokyonight, tokyonight-light, dracula]",
        },
        long_help = indoc! {
            ...
            - catppuccin       (a soothing pastel theme - mocha)
            - catppuccin-light (catppuccin - latte)
            - tokyonight       (a clean, dark theme inspired by Tokyo)
            - tokyonight-light (tokyonight day theme)
